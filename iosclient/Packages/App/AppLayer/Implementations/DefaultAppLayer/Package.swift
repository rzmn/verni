...
let package = Package(
    ...
    dependencies: [
        ...
        .local(.currentLayer(.interface("ActivitiesScreen"))),
        .local(
            .currentLayer(
                .implementation(
                    interface: "ActivitiesScreen", implementation: "DefaultActivitiesScreen"))),
        .local(
            .currentLayer(
                .implementation(
        ...
        .local(
            .currentLayer(
                .implementation(
                    interface: "SpendingsGroupScreen", implementation: "DefaultSpendingsGroupScreen"))),
        .local(
            .currentLayer(
                .implementation(
