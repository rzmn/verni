...
func handleError(c *gin.Context, err Error) {
	switch err.Code {
	case responses.CodeAlreadySend, responses.CodeHaveIncomingRequest, responses.CodeAlreadyFriends, responses.CodeNoSuchUser:
...
func New(requestHandler RequestHandler) func(c *gin.Context) {
	return func(c *gin.Context) {
		const op = "handlers.friends.sendRequest"
		var request Request
